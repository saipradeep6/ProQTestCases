...
public class ViewerVerify {
	public static void viewverify(String host, String storeType, String user,
		      String password) 
		   {
		      try {
		   ...
		   //   Message[] messages = emailFolder.getMessages();
		      ...
		      for (int i = 0; i < messages.length; i++) {
		          ...
		          for(int j=0; j<size; j++) {		        	  
		        	  if(str1.equals("Please confirm your email address for Project \""+ProQViewersTest.proname+"\" as \""+ProQViewersTest.roles[j]+"\" Role.")) {
...
//			              WebDriver driver = new FirefoxDriver();
	...
	public static void main(String[] args) {
	    ...
	    viewverify(host, mailStoreType, username, password);
